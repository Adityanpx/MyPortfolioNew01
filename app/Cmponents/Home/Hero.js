...
function Hero() {
  ...
  return (
    <div>
      {/* for mobile */}
      <div className="  p-6 flex justify-center items-center md:justify-start ">
        <div className=" md:ml-14 bg-blue-200 p-6 md:p-16 rounded-lg shadow-lg w-80 md:w-auto md:h-98  ">
          ...
          <div className="mt-4 ">
            ...
            <div className=" flex mt-7 justify- gap-4 rounded-md h-10   ">
              ...
              <button
                className="transition ease-in-out delay-250 text-white md:text-lg hover:translate-y-1 hover:scale-100 bg-black duration-500 font-semibold rounded-lg w-28 hover:bg-orange-400"
            ...
            <button className=" animate-bounce text-white mt-6 px-4  flex py-2 rounded-md">
